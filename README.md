...
L'utilisateur crée son avatar. Il doit donc sélectionner le personnage et son accessoire. Chaque accessoire a un bonus : bonus de secondes, commencer la partie avec un score à 25, qu'une paire se retourne automatiquement au début de la partie ou la possibilité de retourner toute les cartes en plein milieu de la partie. ces fonctions elles pourront être activées une seule fois lorsque l'utilisateur cliquera sur l'emoticône de l'accessoire de son avatar 
